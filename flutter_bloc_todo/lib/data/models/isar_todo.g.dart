...
extension TodoIsarQueryFilter
  ...
  QueryBuilder<TodoIsar, TodoIsar, QAfterFilterCondition> bodyEqualTo(
    String value, {
  ...
  QueryBuilder<TodoIsar, TodoIsar, QAfterFilterCondition> bodyGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<TodoIsar, TodoIsar, QAfterFilterCondition> bodyLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<TodoIsar, TodoIsar, QAfterFilterCondition> bodyBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<TodoIsar, TodoIsar, QAfterFilterCondition> bodyStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoIsar, TodoIsar, QAfterFilterCondition> bodyEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoIsar, TodoIsar, QAfterFilterCondition> bodyContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoIsar, TodoIsar, QAfterFilterCondition> bodyMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoIsar, TodoIsar, QAfterFilterCondition> bodyIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'body',
        value: '',
  ...
  QueryBuilder<TodoIsar, TodoIsar, QAfterFilterCondition> bodyIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'body',
        value: '',
...
extension TodoIsarQuerySortBy on QueryBuilder<TodoIsar, TodoIsar, QSortBy> {
  QueryBuilder<TodoIsar, TodoIsar, QAfterSortBy> sortByBody() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'body', Sort.asc);
    });
  }

  QueryBuilder<TodoIsar, TodoIsar, QAfterSortBy> sortByBodyDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TodoIsarQuerySortThenBy
  ...
  QueryBuilder<TodoIsar, TodoIsar, QAfterSortBy> thenByBody() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'body', Sort.asc);
    });
  }

  QueryBuilder<TodoIsar, TodoIsar, QAfterSortBy> thenByBodyDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'body', Sort.desc);
    });
  }
...
extension TodoIsarQueryWhereDistinct
  ...
  QueryBuilder<TodoIsar, TodoIsar, QDistinct> distinctByBody(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension TodoIsarQueryProperty
  ...
  QueryBuilder<TodoIsar, String, QQueryOperations> bodyProperty() {
    return QueryBuilder.apply(this, (query) {
